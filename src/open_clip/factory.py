...
from .model import CLIP, CustomTextCLIP,CLIP_Vision,CLIP_Tabular, convert_weights_to_lp, convert_to_custom_text_state_dict,\
...
def create_model(
    ...
    if custom_text:
        ...
        model = CLIP(**model_cfg, cast_dtype=cast_dtype,logitscaletrainable=logitscaletrainable)
...
def create_loss(args):
    if args.distill:
    ...
    elif args.multipositiveloss and args.visiononly:
        return MultiPositiveClipLossVisionOnly(
            local_loss=args.local_loss,
            gather_with_grad=args.gather_with_grad,
            cache_labels=False,
            rank=args.rank,
    ...
    elif args.multipositiveloss and args.visiononly==False and args.lam is None and args.distance is False:
    ...
    elif args.multipositiveloss and args.visiononly==False and args.lam is None and args.distance is True:
        return MultiPositiveClipLossWithDistance(
            local_loss=args.local_loss,
            gather_with_grad=args.gather_with_grad,
            cache_labels=False,
            rank=args.rank,
        ...
        return MultiPositiveClipLosswithVision(
            local_loss=args.local_loss,
            gather_with_grad=args.gather_with_grad,
            cache_labels=False,
            rank=args.rank,
